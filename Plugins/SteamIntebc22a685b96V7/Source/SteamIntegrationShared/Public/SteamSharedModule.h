...
class STEAMINTEGRATIONSHARED_API FSteamSharedModule : public IModuleInterface
{
public:
	...
	{
		return FModuleManager::LoadModuleChecked<class FSteamSharedModule>("SteamIntegrationShared");
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded("SteamIntegrationShared");
	}
...
class STEAMINTEGRATIONSHARED_API FSteamInstanceHandlerBase
{
public:
...
class STEAMINTEGRATIONSHARED_API FSteamClientInstanceHandler final : public FSteamInstanceHandlerBase
{
public:
...
class STEAMINTEGRATIONSHARED_API FSteamServerInstanceHandler final : public FSteamInstanceHandlerBase
{
public:
